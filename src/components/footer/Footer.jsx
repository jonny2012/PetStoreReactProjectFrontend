...
const Footer = () => {
  ...
  const box_style = {
    fontSize: isTabletOrMobile ? "1.5em" : "2.5em",
    fontWeight: "600",
    color: "#282828",
  };
  ...
  return (
    ...
    >
      <Typography
        fontWeight="700"
        fontSize={isTabletOrMobile ? "48px" : "64px"} 
        variant="h2"
      >
        Contact
      </Typography>
      ...
      >
        <Box sx={inbox_styles} width={isTabletOrMobile ? "100%" : "56vw"}>
          <Typography variant="body1" color="#8B8B8B"> 
            Phone
          </Typography>
          <Typography sx={box_style}>+4930915-88492</Typography>
        </Box>
        <Box sx={inbox_styles} width={isTabletOrMobile ? "100%" : "30vw"}>
          <Typography variant="body1" color="#282828"> 
            Socials
          </Typography>
        ...
        <Box sx={inbox_styles} width={isTabletOrMobile ? "95%" : "56vw"}>
          <Typography variant="body1" color="#282828"> 
            Address
          </Typography>
          <Typography sx={box_style}>
            Wallstraẞe 9-13, 10179 Berlin, Deutschland
          </Typography>
        </Box>
        <Box sx={inbox_styles} width={isTabletOrMobile ? "95%" : "30vw"}>
          <Typography variant="body1" color="#282828"> 
            Working Hours
          </Typography>
